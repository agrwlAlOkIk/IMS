...
<body>
    ...
    <div class="form-container">
        ...
        <form  class="form" method="post" action="SupplierInsert.php">
            ...
            S_CONTACT: <input type="text" name="s_contact"><br>
    ...
    <div id="data-container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "INSERT INTO Supplier (s_id, p_id, s_address, s_name, s_contact) VALUES ('$S_ID', '$P_ID', '$S_ADDRESS' , '$S_NAME', '$S_CONTACT')";
