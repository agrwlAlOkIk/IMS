...
<body>
    ...
    <div class="form-container">
        ...
        <form class="form" method="post" action="PurchaseOrderInsert.php">
    ...
    <div id="data-container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "INSERT INTO PurchaseOrder (s_id, orderDate, order_status) VALUES ('$S_ID', '$ORDER_DATE', '$ORDER_STATUS')";
